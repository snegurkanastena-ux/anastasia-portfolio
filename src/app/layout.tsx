...
const yandexMetrikaId = 111188288;
    ...
    },
    {
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          ...
          {
            "@type": "Offer",
            name: "SEO-старт / подготовка к поиску",
            priceCurrency: "RUB",
            priceSpecification: { "@type": "PriceSpecification", minPrice: 10000, priceCurrency: "RUB" },
            itemOffered: { "@type": "Service", serviceType: "Подготовка сайта к поиску и индексации" },
          },
        ],
      },
    },
      ...
      <body className={`${display.variable} ${sans.variable} ${signature.variable} app-canvas`}>
        <Script id="yandex-metrika" strategy="afterInteractive">
          {`
            ...
            })(window, document, 'script', 'https://mc.yandex.ru/metrika/tag.js?id=111188288', 'ym');
